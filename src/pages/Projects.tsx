...
export const Projects = () => {
    ...
    const [displayedImage, setDisplayedImage] = useState(currentProject?.projectImages ? currentProject?.projectImages[currentIndex] : undefined);
            ...
            <div className={styles.mainBody}>
                <div className={styles.topDiv}>
                    ...
                    <div className={styles.imageContainer}>
                        ...
                        <div className={styles.arrowContainer}>
                            <button className={styles.rightArrow} onClick={() => imageSelector(currentIndex + 1)}>{'>'}</button>
                        </div>
                    </div>
                    : undefined}
                </div>
